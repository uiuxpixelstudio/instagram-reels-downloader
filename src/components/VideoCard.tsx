      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center rounded-lg border border-gray-300 px-3 py-2 text-gray-600 transition hover:bg-red-50 hover:text-red-600 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-red-900 dark:hover:text-red-400"
          >
